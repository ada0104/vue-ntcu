...
<script>
    var mission_list = new Vue({
        el: "#mission_list",
        data: { mission_list: [], page_size: 10, current_page: 1, teacherClass: [], selectedObject: "", current_classroom: null, studentData: [], current_student: "",student_data:[],isParent:false },
        mounted() {
            //一進來先判斷
            this.identity();  
        },
