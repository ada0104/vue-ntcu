    ...
    <div id="competency" class="content2-Box">
        ...
        <template v-if="main=='self'">
            ...
            <el-card shadow="hover" class="box-card">
                <el-carousel indicator-position="outside" :interval="5000" height="400" :autoplay="false">
                    <el-carousel-item v-for="range of chartRanges">
                        <radar :labels="dscs" :datas="score" :range="range" :mission_avg="mission_data" v-if="score.filter(v=>v.unit_id=='total-0')"></radar>
                    </el-carousel-item>
                </el-carousel>
            </el-card>
...
<script>
    ...
    var radar = Vue.extend({
        ...
        props: ["labels", "datas", "range", "mission_avg"],
        data() {
            return {
                chartData: {
                    ...
                    datasets: [{
                        ...
                        // borderColor:"rgba(232,164,48,0.53)",
                        backgroundColor: "rgba(232,164,48,0.53)",
        ...
        created() {
            ...
            if (this.mission_sn) {
                ...
                axios.post("modules/assignMission/assignment/competencyScore.php", formatToForm({ mission_sn: this.mission_sn }))
                    .then(response => {
                        this.mission_data=response.data;
                        // $.LoadingOverlay("hide");
                    });
